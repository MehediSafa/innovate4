...
function CustomNextArrow(props) {
  ...
  return (
    <div
      className="absolute top-1/2 right-[0px] transform -translate-y-1/2 z-10 w-[50px] h-[50px] flex items-center justify-center bg-[#FF7628] rounded-full cursor-pointer shadow-md hover:bg-[#FF5722] md:right-[0px]"
      onClick={onClick}
    >
...
function CustomPrevArrow(props) {
  ...
  return (
    <div
      className="absolute top-1/2 left-[0px] transform -translate-y-1/2 z-10 w-[50px] h-[50px] flex items-center justify-center bg-[#FF7628] rounded-full cursor-pointer shadow-md hover:bg-[#FF5722] md:left-[0px]"
      onClick={onClick}
    >
          ...
          <Slider {...settings}>
            ...
            <div className="p-6 flex flex-col items-center bg-white rounded-[20px] shadow-lg hover:scale-105 transition-transform duration-300 mx-3">
              ...
              <div className="flex items-center mt-4">
                ...
                />
                <div className="ml-3">
                  <h3 className="text-[#202427] font-bold text-[18px]">
                    Eleanor Pena
                  </h3>
            ...
            <div className="p-6 flex flex-col items-center bg-[#E3F2FD] rounded-[20px] shadow-lg hover:scale-105 transition-transform duration-300 mx-3">
              ...
              />
              <p className="text-[#6C7D93] font-normal text-[16px] text-center">
                "Their expertise and dedication have been invaluable in our
            ...
            <div className="p-6 flex flex-col items-center bg-[#FFEBEE] rounded-[20px] shadow-lg hover:scale-105 transition-transform duration-300 mx-3">
              ...
              />
              <p className="text-[#6C7D93] font-normal text-[16px] text-center">
                "The team provided excellent results. Their strategy brought us
                amazing growth and leads."
              </p>
              <div className="flex items-center mt-4">
                <img
                  src={rev1}
