  ...
  return (
    <section className='my-[80px]'>
        <Container>
            ...
            <div className='lg:w-[30%] w- h-[247px] bg-[#EBF7E9] rounded-[20px] lg:mb-0 mb-[20px]'>
            ...
            <h2 className='font-sans font-semibold text-[30px] pt-[18px] pb-[20px] lg:text-start text-center lg:ms-[40px] ms-0'>Social media integration</h2>
            <h2 className='font-sans font-semibold text-[18px] text-[#6C7D93]  lg:text-start text-center lg:ms-[40px] ms-0 pt-[20px] pb-[40px]'>Practical tools and features make it easier to build and manage your site.
            </h2>
            </div>
