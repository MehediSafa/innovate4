      ...
      <Container>
        ...
        <div className=" flex flex-col  lg:flex-row relative">
          ...
          <div className="lg:w-1/2 w-full relative mt-10 lg:mt-[95px] flex justify-center items-center">
            <img
              className="rounded-[30px] lg:rounded-[60px] w-[80%] lg:w-full"
              src={right1}
              alt="Right"
            />
            <img
            ...
            {/* Floating Icons */}
            <img
              className="absolute top-[-40px] lg:top-[-140px] lg:left-2"
              src={fb}
              alt="Facebook"
            />
            <img
              className="absolute top-[200px] lg:top-[180px] left-[40px] lg:left-[-140px]"
              src={insta}
              alt="Instagram"
            />
            <img
              className="absolute top-[200px] lg:top-[250px] right-[-0px] lg:right-[-40px]"
              src={whatsapp}
              alt="WhatsApp"
            />
          </div>
          ...
          <div className="absolute top-[-150px] lg:top-[-200px]right-[-50px] lg:right-[-180px] z-[-1] overflow-x-hidden">
            <img src={thread2} alt="Thread 2" className="hidden" />
          </div>
